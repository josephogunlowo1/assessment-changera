...
exports.newDB1622638070113 = void 0;
class newDB1622638070113 {
    constructor() {
        this.name = 'newDB1622638070113';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query("CREATE TABLE `delivery__person` (`DPid` varchar(36) NOT NULL, `name` text NOT NULL, `available` tinyint NOT NULL DEFAULT 1, PRIMARY KEY (`DPid`)) ENGINE=InnoDB");
            ...
            yield queryRunner.query("CREATE TABLE `food` (`Fid` varchar(36) NOT NULL, `name` text NOT NULL, `description` text NOT NULL, `quantity` int NOT NULL DEFAULT '1', `price` float NOT NULL, `restaurantId` varchar(255) NOT NULL, `available` tinyint NOT NULL DEFAULT 1, `userId` varchar(255) NULL, `orderId` int NULL, PRIMARY KEY (`Fid`)) ENGINE=InnoDB");
            ...
            yield queryRunner.query("ALTER TABLE `food` ADD CONSTRAINT `FK_1b6534b8f7b3ff1d45f4d480341` FOREIGN KEY (`orderId`) REFERENCES `order`(`Oid`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query("ALTER TABLE `food` DROP FOREIGN KEY `FK_1b6534b8f7b3ff1d45f4d480341`");
...
exports.newDB1622638070113 = newDB1622638070113;
//# sourceMappingURL=1622638070113-newDB.js.map