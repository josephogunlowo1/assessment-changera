...
exports.finalDB1623419280160 = void 0;
class finalDB1623419280160 {
    constructor() {
        this.name = 'finalDB1623419280160';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query("CREATE TABLE `address` (`Addressid` varchar(36) NOT NULL, `city` text NOT NULL, `state` text NOT NULL, `Country` text NOT NULL, `location` text NOT NULL, `pincode` text NOT NULL, `phone` varchar(9) NULL, PRIMARY KEY (`Addressid`)) ENGINE=InnoDB");
            ...
            yield queryRunner.query("CREATE TABLE `image` (`id` varchar(36) NOT NULL, `imagePath` text NOT NULL, `foodId` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
            ...
            yield queryRunner.query("CREATE TABLE `rating` (`userId` varchar(255) NOT NULL, `RestaurantId` varchar(255) NOT NULL, `rating` float NOT NULL DEFAULT '0', `review` text NULL, PRIMARY KEY (`userId`, `RestaurantId`)) ENGINE=InnoDB");
            yield queryRunner.query("CREATE TABLE `restaurant` (`Rid` varchar(36) NOT NULL, `name` text NOT NULL, `tag` text NOT NULL, `available` tinyint NOT NULL DEFAULT 1, `discount` float NULL, `totalRating` float NOT NULL DEFAULT '0', `addressAddressid` varchar(36) NULL, UNIQUE INDEX `REL_4642c5775e0de2541be48c84c8` (`addressAddressid`), PRIMARY KEY (`Rid`)) ENGINE=InnoDB");
            yield queryRunner.query("CREATE TABLE `food` (`Fid` varchar(36) NOT NULL, `name` text NOT NULL, `description` text NOT NULL, `quantity` int NOT NULL DEFAULT '1', `price` float NOT NULL, `available` tinyint NOT NULL DEFAULT 1, `restaurantId` varchar(255) NOT NULL, `userId` varchar(255) NULL, `orderOid` int NULL, PRIMARY KEY (`Fid`)) ENGINE=InnoDB");
            ...
            yield queryRunner.query("CREATE TABLE `coupon` (`id` varchar(36) NOT NULL, `title` text NOT NULL, `value` float NOT NULL, `valid` tinyint NOT NULL DEFAULT 1, `count` int NOT NULL DEFAULT '0', UNIQUE INDEX `IDX_39ea66d350c76d330c7845df00` (`title`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
            ...
            yield queryRunner.query("ALTER TABLE `Lamorak`.`rating` DROP FOREIGN KEY `ratingUser`");
            ...
            yield queryRunner.query("ALTER TABLE `Lamorak`.`rating` DROP FOREIGN KEY `ratingRestaurant`");
            ...
            yield queryRunner.query("ALTER TABLE `Lamorak`.`image` DROP FOREIGN KEY `ImageForFood`");
            ...
            yield queryRunner.query("ALTER TABLE `image` ADD CONSTRAINT `FK_9dd0f874c4419189390ab2da55a` FOREIGN KEY (`foodId`) REFERENCES `food`(`Fid`) ON DELETE NO ACTION ON UPDATE NO ACTION");
            ...
            yield queryRunner.query("ALTER TABLE `rating` ADD CONSTRAINT `FK_a6c53dfc89ba3188b389ef29a62` FOREIGN KEY (`userId`) REFERENCES `user`(`uid`) ON DELETE NO ACTION ON UPDATE NO ACTION");
            yield queryRunner.query("ALTER TABLE `rating` ADD CONSTRAINT `FK_99bc6c32c7a46ee3e0bab8da24d` FOREIGN KEY (`RestaurantId`) REFERENCES `restaurant`(`Rid`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query("ALTER TABLE `rating` DROP FOREIGN KEY `FK_99bc6c32c7a46ee3e0bab8da24d`");
            yield queryRunner.query("ALTER TABLE `rating` DROP FOREIGN KEY `FK_a6c53dfc89ba3188b389ef29a62`");
            yield queryRunner.query("ALTER TABLE `user` DROP FOREIGN KEY `FK_703e68a3d29a874f160ac3797be`");
            yield queryRunner.query("ALTER TABLE `image` DROP FOREIGN KEY `FK_9dd0f874c4419189390ab2da55a`");
            ...
            yield queryRunner.query("ALTER TABLE `Lamorak`.`image` ADD CONSTRAINT `ImageForFood` FOREIGN KEY (`foodId`) REFERENCES `food`(`Fid`) ON DELETE RESTRICT ON UPDATE RESTRICT");
            ...
            yield queryRunner.query("ALTER TABLE `Lamorak`.`rating` ADD CONSTRAINT `ratingRestaurant` FOREIGN KEY (`RestaurantId`) REFERENCES `restaurant`(`Rid`) ON DELETE RESTRICT ON UPDATE RESTRICT");
            ...
            yield queryRunner.query("ALTER TABLE `Lamorak`.`rating` ADD CONSTRAINT `ratingUser` FOREIGN KEY (`userId`) REFERENCES `user`(`uid`) ON DELETE RESTRICT ON UPDATE RESTRICT");
            ...
            yield queryRunner.query("DROP INDEX `IDX_39ea66d350c76d330c7845df00` ON `coupon`");
...
exports.finalDB1623419280160 = finalDB1623419280160;
//# sourceMappingURL=1623419280160-finalDB.js.map